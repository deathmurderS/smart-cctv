        ...
        <div style={{ minHeight: '100vh', background: '#fdf6f0' }}>
            ...
            <div style={{ padding: '32px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
                    <StatCard title="Total Cameras" value={summary.totalCameras || 0} color="#f7c5d0" icon="📷" />
                    <StatCard title="Online Cameras" value={summary.onlineCameras || 0} color="#b8e0d2" icon="🟢" />
                    <StatCard title="Total Events" value={summary.totalEvents || 0} color="#c9b8e8" icon="⚡" />
                </div>

                <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
                    <div style={{ flex: 2, background: 'white', borderRadius: '16px', padding: '24px', boxShadow: '0 4px 20px rgba(247,197,208,0.3)', border: '1px solid #f7c5d040' }}>
                    ...
                    <div style={{ flex: 1, background: 'white', borderRadius: '16px', padding: '24px', boxShadow: '0 4px 20px rgba(247,197,208,0.3)', border: '1px solid #f7c5d040' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
                            <span style={{ fontSize: '20px' }}>📍</span>
